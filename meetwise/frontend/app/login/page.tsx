...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-black dark:to-indigo-950 flex flex-col justify-center items-center px-6 py-24 relative overflow-hidden">
            ...
            {/* Glowing blur mesh background blobs */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
                <div className="absolute top-[20%] left-[10%] w-[350px] h-[350px] rounded-full bg-indigo-300/20 dark:bg-indigo-900/10 blur-[80px] animate-pulse"></div>
            ...
            <div className="w-full max-w-[490px] z-10">
                ...
                <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] p-8 border border-white/40 dark:border-white/10 relative overflow-hidden animate-fadeIn">
                    ...
                    {error && (
                        <div className="mb-4 p-4 bg-red-105 dark:bg-red-950/20 border border-red-200 dark:border-red-900 text-red-750 dark:text-red-400 rounded-xl text-xs">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 pr-4 py-3 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:border-indigo-500 dark:text-gray-100 transition-all text-sm"
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 pr-11 py-3 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:border-indigo-500 dark:text-gray-100 transition-all text-sm"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3.5 px-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.01] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 cursor-pointer text-sm"
                        >
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-xs">
                                <span className="px-3 bg-white dark:bg-gray-800 text-gray-400 uppercase tracking-wider font-extrabold text-[10px]">Or continue with</span>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full py-3 px-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 font-bold rounded-xl shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-800/80 cursor-pointer text-xs"
                        >
                    ...
                    <p className="mt-6 text-center text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <Link href="/register" className="text-indigo-650 dark:text-indigo-400 font-extrabold hover:underline">
                            Create one
                        </Link>
                    </p>
                </div>
